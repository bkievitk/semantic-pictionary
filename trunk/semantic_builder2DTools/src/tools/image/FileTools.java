...
public class FileTools {
	...
	/**
	 * Remove all folders from this directory that do not contain a word stored in words.
	 * @param f
	 * @param words
	 */
	public static void cleanDirectory(File f, Vector<Thought> words) {
		HashSet<String> set = new HashSet<String>();
		
		for(Thought word : words) {
			set.add(word.representation);
		}
